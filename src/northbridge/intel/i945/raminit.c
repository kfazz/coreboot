				...
				struct timings *saved_timings)
{
	...
	{0x80,0x08,0x08,0x0D,0x0a,0x60,0x40,0x00,0x05,0x3D,0x50,0x00,0x82,0x10,0x00,0x00,
	 0x0c,0x04,0x18,0x01,0x04,0x00,0x01,0x50,0x50,0x00,0x00,0x3c,0x28,0x3c,0x2d,0x40,
	 0x25,0x37,0x10,0x22,0x3c,0x1e,0x1e,0x00,0x00,0x3c,0x4b,0x80,0x1e,0x28,0x00,0x00,
	 0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x13,0xAC,
...
//#else
	...
	u8 raw_spd[SPD_SIZE_MAX_DDR2] =
	{};
#else
	...
	u8 raw_spd[SPD_SIZE_MAX_DDR2] =
	{};
...
static void sdram_program_refresh_rate(struct sys_info *sysinfo)
{
	...
	printk(BIOS_DEBUG, "C0DRC0 = 0x%08x\n", MCHBAR32(C0DRC0));

	MCHBAR32(C1DRC0) &= ~(7 << 8);
	MCHBAR32(C1DRC0) |= reg32;
	//printk(BIOS_DEBUG, "C1DRC0 = 0x%08x\n", MCHBAR32(C1DRC0));
}
...
static void sdram_program_cke_tristate(struct sys_info *sysinfo)
{
	...
	reg32 |= (1 << 11);
	MCHBAR32(C0DRC1) = reg32;
	printk(BIOS_DEBUG, "C0DRC1 = 0x%08x\n", MCHBAR32(C0DRC1));
	...
	reg32 |= (1 << 11);
	MCHBAR32(C1DRC1) = reg32;
	//printk(BIOS_DEBUG, "C1DRC1 = 0x%08x\n", MCHBAR32(C1DRC1));
}
...
static void sdram_program_odt_tristate(struct sys_info *sysinfo)
{
	...
	printk(BIOS_DEBUG, "C0DRC2 = 0x%08x\n", MCHBAR32(C0DRC2));
	...
	//printk(BIOS_DEBUG, "C1DRC2 = 0x%08x\n", MCHBAR32(C1DRC2));
}
...
static void sdram_set_timing_and_control(struct sys_info *sysinfo)
{
	...
	printk(BIOS_DEBUG, "C0DRT0 = 0x%08x\n", MCHBAR32(C0DRT0));
	MCHBAR32(C1DRT0) = temp_drt;
	//printk(BIOS_DEBUG, "C1DRT0 = 0x%08x\n", MCHBAR32(C1DRT0));
	...
	printk(BIOS_DEBUG, "C0DRT1 = 0x%08x\n", MCHBAR32(C0DRT1));
	MCHBAR32(C1DRT1) = temp_drt;
	//printk(BIOS_DEBUG, "C1DRT1 = 0x%08x\n", MCHBAR32(C1DRT1));

	/* Program DRT2 */
	reg32 = MCHBAR32(C0DRT2);
	reg32 &= ~(1 << 8);
	MCHBAR32(C0DRT2) = reg32;
	printk(BIOS_DEBUG, "C0DRT2 = 0x%08x\n", MCHBAR32(C0DRT2));

	reg32 = MCHBAR32(C1DRT2);
	reg32 &= ~(1 << 8);
	MCHBAR32(C1DRT2) = reg32;
	//printk(BIOS_DEBUG, "C1DRT2 = 0x%08x\n", MCHBAR32(C0DRT2));
	...
	printk(BIOS_DEBUG, "C0DRT3 = 0x%08x\n", MCHBAR32(C0DRT3));
	MCHBAR32(C1DRT3) = temp_drt;
	//printk(BIOS_DEBUG, "C1DRT3 = 0x%08x\n", MCHBAR32(C1DRT3));
}
...
#if 1 // IS_ENABLED(CONFIG_OVERRIDE_CLOCK_DISABLE)
