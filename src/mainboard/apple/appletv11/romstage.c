...
static void rcba_config(void)
{
	...
	RCBA32(D28IP) = 0x00214321; /* PCIe Interrupts */ /*non-default */
	RCBA32(D27IP) = 0x00000001; 	/* HD Audio Interrupt */
	...
	RCBA32(FD) = 0x003e0ee4; // FD_PCIE6 | FD_PCIE5 | FD_PCIE4 | FD_PCIE3 | FD_PCIE2 
	//	/*| FD_UHCI234*/ | FD_INTLAN | FD_SATA | FD_ACMOD | FD_ACAUD;
...
static void early_ich7_init(void)
{
	...
	RCBA32(0x0088) = 0x0011d000; //same
	RCBA16(0x01fc) = 0x060f; //same
	RCBA32(0x01f4) = 0x86000040; //same
	RCBA32(0x0214) = 0x10030549; //same
	RCBA32(0x0218) = 0x00020504; //same
	RCBA8(0x0220) = 0xc5;	//same
	reg32 = RCBA32(GCS);
	reg32 |= (0x810000); //(1 << 6);
	RCBA32(GCS) = reg32;
	...
	RCBA32(0x024c) = 0x00320000;
	RCBA32(0x0250) = 0x00380000;
	RCBA32(0x0254) = 0x009f03e8;
	RCBA32(0x0258) = 0x009f09bb;
	RCBA32(0x0260) = 0x00a20d1c;
	RCBA32(0x0278) = 0x00750558;
	RCBA32(0x027c) = 0x00790560;
	RCBA32(0x0280) = 0x00a30000;
	...
	reg32 |= (5 << 16);
	RCBA32(0x2034) = reg32;
	RCBA32(0x3ffc) = 0x00000001;
}

void mainboard_romstage_entry(unsigned long bist)
{
	int s3resume = 0;
	const u8 spd_addrmap[2 * DIMM_SOCKETS] = { 0x50,0,0,0}; //, 0x51, 0x52, 0x53 };
