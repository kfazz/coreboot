...
If (PICM) {
	Return (Package() {
		...
		Package (0x04) { 0x0003FFFF, 0x00, 0x00, 0x14 },
		Package (0x04) { 0x0003FFFF, 0x01, 0x00, 0x14 },
		Package (0x04) { 0x0003FFFF, 0x02, 0x00, 0x14 },
		Package (0x04) { 0x0003FFFF, 0x03, 0x00, 0x14 },
	...
	Return (Package() {
		...
		Package (0x04) { 0x0003FFFF, 0x00, \_SB.PCI0.LPCB.LNKE, 0x00 },
		Package (0x04) { 0x0003FFFF, 0x01, \_SB.PCI0.LPCB.LNKE, 0x00 },
		Package (0x04) { 0x0003FFFF, 0x02, \_SB.PCI0.LPCB.LNKE, 0x00 },
		Package (0x04) { 0x0003FFFF, 0x03, \_SB.PCI0.LPCB.LNKE, 0x00 },
